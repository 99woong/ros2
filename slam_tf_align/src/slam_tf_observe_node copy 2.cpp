...
public:
  SlamTfObserveNode() : Node("slam_tf_observe")
  {
    ...
    min_rotation_rad_ =
      declare_parameter<double>("min_rotation_deg", 45.0) * M_PI / 180.0;
    output_yaml_ =
...
private:
    ...
    const PoseStamped::ConstSharedPtr seven)
  {
    ...
    RCLCPP_INFO(get_logger(), "Extrinsic observation finished");
  }
