...
public:
    ArcPublisher() : Node("fms_mqtt_publish") 
    {
        ...
        for(int i=0;i<2;i++)
        {
            std::string input_file_path = "/home/zenix/ros2_ws/src/fms_mqtt_publish/amr_" + std::to_string(i) + "_order.json";            
            std::string output_file_path = "/home/zenix/ros2_ws/src/fms_mqtt_publish/amr_" + std::to_string(i) + "_order_arc.json";            
